...
### v1.11.0 (最新)
- 🎨 **MD3规范**：完善Material Design 3设计规范，统一卡片样式
- 🤖 **AI优化**：AI智能助手配色优化，AI标签智能显示
- 🚗 **通勤系统**：通勤提醒主题响应，与天气提醒设计统一
- 🎨 **配色优化**：禁用蓝色系小卡片，改用绿色/橙色提升对比度
- 📋 **布局调整**：今日提醒位置前移，数量标签始终显示
- 👆 **交互优化**：小卡片点击交互，展开/收起更直观
