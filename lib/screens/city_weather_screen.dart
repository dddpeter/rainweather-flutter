          ...
          child: Consumer<WeatherProvider>(
            builder: (context, weatherProvider, child) {
                ...
                return Center(
                  child: Column(
                    ...
                    children: [
                      ...
                      ElevatedButton(
                        onPressed: () => weatherProvider.getWeatherForCity(widget.cityName),
                        child: const Text('重试'),
                      ),
                    ],
                  ),
              ...
              return RefreshIndicator(
                onRefresh: () => weatherProvider.getWeatherForCity(widget.cityName),
                color: Colors.blue,
    ...
    return Container(
      ...
      child: SafeArea(
        child: Padding(
          ...
          child: Column(
            children: [
              // Header with back button and city name
              Row(
                children: [
                  IconButton(
